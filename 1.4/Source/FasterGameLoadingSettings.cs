...
namespace FasterGameLoading
{
    public class FasterGameLoadingSettings : ModSettings
    {
        ...
        public static void DoSettingsWindowContents(Rect inRect)
        {
            ...
            ls.CheckboxLabeled("Prevent graphic and icon loading during startup and load them gradually during playing. Will cut some time off during loading, however it might be not stable and error prone. Disable this if you will encounter any issues with graphics.", ref delayGraphicLoading);
